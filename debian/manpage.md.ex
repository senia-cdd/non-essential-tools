% non-essential-tools(SECTION) | User Commands
%
% "April 26 2024"
...
non-essential-tools - program to do something

# SYNOPSIS

**non-essential-tools** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**non-essential-tools** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **non-essential-tools** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**non-essential-tools** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    non-essential-tools. See **foo.conf**(5) for further details.
...
**non-essential-tools** provides some return codes, that can be used in scripts:
...
tic La Senia <tic@ieslasenia.org>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 tic La Senia
